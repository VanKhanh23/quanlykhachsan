...
namespace quanlykhachsan
{
    public partial class frmdangnhap : Form
    {
        ...
        private void btndangnhap_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(@"Data Source=LAPTOP-BSGEG72V;Initial Catalog=quanlykhachsan;Integrated Security=True");
            ...
            if (cbkhach.Checked == true)
            {
                trangthai(false);
                this.Hide(); // Form Đăng Nhập sẽ ẩn đi => MainForm sẽ load lên
                frmthongtinphongkh frm = new frmthongtinphongkh(); //chi xem duoc thong tin phong
                frm.Show();
